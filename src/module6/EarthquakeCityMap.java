...
public class EarthquakeCityMap extends PApplet {
    ...
    private boolean hiddenInOcean = false;

    public void setup() {
        // (1) Initializing canvas and map tiles
        size(900, 700, OPENGL);
        if (offline) {
            map = new UnfoldingMap(this, 230, 50, 650, 600, new MBTilesMapProvider(mbTilesString));
            ...
            map = new UnfoldingMap(this, 230, 50, 650, 600, new Google.GoogleMapProvider());
    ...
    public void keyPressed() {
        ...
        if (key == 'c') {
            ...
            //Press 'l' to hide earthquakes in land
        } else if (key == 'l') {
            ...
            //Press 'o' to hide earthquakes in ocean
        } else if (key == 'o') {
            if (hiddenInOcean == false) {
                hideInOcean();
                hiddenInOcean = true;
            } else if (hiddenInOcean == true) {
                unhideInOcean();
                hiddenInOcean = false;
            }
        }
    ...
    private void addKey() {
        ...
        text("c - hide cities", xbase + 30, ybase + 240);
        text("l - hide earthquakes in land", xbase + 30, ybase + 260);
        text("o - hide earthquakes in ocean", xbase + 30, ybase + 280);
